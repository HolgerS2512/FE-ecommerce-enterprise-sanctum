    ...
    resources: {
      de: {
        translation: {
          ...
          fromPrices: 'ab',
          upToPrice: "BIS ZU -{{ reduce }}%",
          help: 'Hilfe',
          view: 'Ansicht',
          wcag_animated: 'Animationen',
          wcag_colors: 'Rot-Grün Farben',
          wcag_settings: 'Barrierefreiheitseinstellungen',
          wcag: 'Barrierefreiheit',
          wcag_short: 'Barrierefrei',
          on: 'An',
          off: 'Aus',
        },
      },
      en: {
        translation: {
          ...
          fromPrices: 'from',
          upToPrice: "UP TO -{{ reduce }}%",
          help: 'Help',
          view: 'View',
          wcag_animated: 'Animations',
          wcag_colors: 'Red-Green Colors',
          wcag_settings: 'Accessibility Settings',
          wcag: 'Accessibility',
          wcag_short: 'Accessible',
          on: 'On',
          off: 'Off',
        },
      },
