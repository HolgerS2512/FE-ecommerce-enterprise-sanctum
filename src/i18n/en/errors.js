export const errors = {
  ...
  password: "At least 8 characters, upper and lower case letters and a number.",
  pin: "Your PIN code must consist only of numbers and must be exactly 5 characters long.",

  pwd_addition_char: "At least 8 characters",
  pwd_additions:
    "Uppercase and lowercase letters, special characters and a number",
